...
import RecruitList from '../Recruits/RecruitList'
      ...
      <Container className="h-100">
        {loading ? (
          ...
          <div className="w-100 h-100 d-flex align-items-center justify-content-center">
            <h2>Для работы необходимо войти в систему 🚪</h2>
          </div>
        ) : (
          <>
            <Row>
                    ...
                    <Row>
                      <Col md="auto" className="p-0">
                        <Card.Img
                          ...
                          src={
                            '/avatars/' +
                            (user.avatar ? user.avatar : 'no-avatar.jpg')
                          }
                        />
                      </Col>
                      <Col>
                        <Card.Body>
                          ...
                          <Card.Text className={classes.info}>
                            <Globe size={18} className={classes.icon} />
                            {user.email}
                          </Card.Text>
                          <Card.Text className={classes.info}>
                            <TelephoneFill size={18} className={classes.icon} />
                            {user.phoneNumber}
                          </Card.Text>
                        </Card.Body>
                      </Col>
